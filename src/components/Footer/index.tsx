        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full text-center">
              ...
              <p className="mx-auto mb-8 text-base text-gray-400">Always ready for you.</p>
          ...
          <div className="flex flex-wrap justify-between gap-4">
            ...
            <div className="w-full sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
              <div className="mb-10 w-full">
                <h4 className="mb-9 text-lg font-semibold text-white">Useful Links</h4>
                <ul>
                  <li>
                    <Link
                      href="/free-resources"
            ...
            <div className="w-full sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
              <div className="mb-10 w-full">
                <h4 className="mb-9 text-lg font-semibold text-white">Updates</h4>
