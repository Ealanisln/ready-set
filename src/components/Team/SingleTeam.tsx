  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        ...
        <div className="group mb-8 rounded-xl bg-white px-5 pb-10 pt-12 shadow-testimonial dark:bg-dark dark:shadow-none cursor-pointer hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="grid gap-4 py-4">
          <Image
            ...
            height={200}
          />
          <p>More details about {name} can be added here.</p>
        </div>
