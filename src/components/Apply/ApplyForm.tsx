          ...
          {isSubmitted ? (
            <div className="p-10 text-center">
              ...
              <div className="mb-6 text-lg text-gray-600">
                <p>Thank you for applying to Ready Set Group.</p>
                <p className="mt-2">We have received your application and will review it shortly.</p>
                <p className="mt-2">Our team will contact you soon about the next steps.</p>
              </div>
              <div className="mb-6 rounded-lg bg-yellow-50 p-4 text-left">
                <h3 className="mb-2 font-medium text-yellow-800">What happens next?</h3>
                <ol className="ml-4 list-decimal text-yellow-700">
                  <li className="mb-1">Our team will review your application</li>
                  <li className="mb-1">If you're a good fit, we'll reach out to schedule an interview</li>
                  <li className="mb-1">We'll keep you informed about your application status</li>
                </ol>
              </div>
              <button
                onClick={() => {
                  // Reset form state to start a new application
                ...
                className="mt-4 inline-flex items-center rounded-md bg-yellow-400 px-6 py-3 font-medium text-white hover:bg-yellow-500 focus:outline-none focus:ring-2 focus:ring-yellow-400"
              >
